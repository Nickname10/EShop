...
function renderRequest() {
    ...
    const formRequest = {
        ...
        "Min-value": document.querySelector('.slider-value-min').textContent,
        "Max-value": document.querySelector('.slider-value-max').textContent,
        "Brand": [],
        "Sizes": []
    };
    for (let i = 2; i < 6; i++)
...
function toQueryString(obj) {
    ...
    return `&Page=${obj["Page"]}&Discount=${obj["Discount"]}&New=${obj["New"]}&Min-value=${obj["Min-value"]}&Max-value=${obj["Max-value"]}&${Brand}&${Size}`
}